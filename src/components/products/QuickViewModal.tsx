      ...
      {quickViewProduct && (
        <div className="fixed inset-0 z-50 flex items-center justify-center p-4 sm:p-6 overflow-y-auto">
          ...
          <motion.div
            ...
            className="relative w-full max-w-4xl bg-slate-900 border border-slate-800 rounded-3xl shadow-2xl overflow-hidden z-10 my-8 text-white"
          >
            {/* Close Button */}
            <button
              onClick={() => setQuickViewProduct(null)}
              ...
              <div className="flex flex-col justify-between space-y-4">
                <div className="space-y-3">
                  <div className="flex items-center justify-between">
                    ...
                    {product.stock > 0 ? (
                      <span className="inline-flex items-center gap-1 text-xs font-semibold text-emerald-400 bg-emerald-950/80 px-2.5 py-1 rounded-md border border-emerald-500/30">
                        <CheckCircle2 className="w-3.5 h-3.5" /> In Stock ({product.stock})
                      </span>
                    ) : (
                      <span className="inline-flex items-center gap-1 text-xs font-semibold text-amber-400 bg-amber-950/80 px-2.5 py-1 rounded-md border border-amber-500/30">
                  ...
                  <div className="space-y-2 pt-2 border-t border-slate-800">
                    ...
                    <div className="grid grid-cols-1 sm:grid-cols-2 gap-2 text-xs">
                      {Object.entries(product.specifications).map(([key, val]) => (
                        <div key={key} className="bg-slate-950/60 p-2.5 rounded-xl border border-slate-800/80">
                ...
                <div className="space-y-4 pt-4 border-t border-slate-800">
                  ...
                  <div className="text-center pt-1">
                    ...
                    >
                      View Full Product Page & Reviews <ExternalLink className="w-3 h-3" />
                    </Link>
                  </div>
                </div>
              </div>
