...
export default function ProductCard({ product }: ProductCardProps) {
	...
	return (
		...
		>
			...
			{/* Card Actions */}
			<div className="p-2 pt-0 grid grid sm:grid-cols-2 gap-2">
				<button
					...
					className={`flex items-center justify-center gap-1.5 py-2 px-2 rounded-xl text-xs font-bold transition-all cursor-pointer ${
						addedToast
							...
							: 'bg-slate-800 text-slate-200 hover:scale-105 hover:text-white'
					}`}
				>
				...
				<a
					...
					className="flex items-center justify-center gap-1.5 bg-emerald-600 hover:bg-emerald-500 hover:scale-105 text-white py-2 px-2 rounded-xl text-xs font-extrabold shadow-sm transition-all"
				>
					<svg
						...
						xmlns="http://w3.org"
					>
						<path d="M.057 24l1.687-6.163c-1.041-1.804-1.588-3.849-1.587-5.946C.06 5.348 5.397.01 12.008.01c3.202.001 6.212 1.246 8.477 3.516 2.266 2.27 3.507 5.28 3.505 8.484-.004 6.657-5.34 11.997-11.953 11.997-2.005-.001-3.973-.503-5.713-1.458L0 24zm6.59-3.57c1.6.95 3.51 1.45 5.42 1.45 5.37 0 9.74-4.37 9.74-9.74-.00-2.59-1.01-5.02-2.83-6.84-1.82-1.82-4.25-2.83-6.84-2.83-5.38 0-9.75 4.37-9.75 9.75 0 2 .52 3.95 1.52 5.67l-.99 3.61 3.7-.97z" />
					</svg>
					<span>Chat</span>
				</a>
			</div>
